package com.lykke.api.testing.queryparams;
...
import com.lykke.api.testing.queryparams.model.a.ObjectListRequest;
import com.lykke.api.testing.queryparams.model.a.PagedRequestModel;
import com.lykke.api.testing.queryparams.model.b.EventListRequest;
...
public class QueryParamsUtilsTests {
    ...
    @Test
    void shouldNotExtractParametersOnSpecificIgnoreSettings() {
    ...
    @Test
    void shouldExtractParametersOnClassWithStringFieldsCamelized() {
        val actualResult = getQueryParams(OnlyStringClass
                .builder()
                .stringData1(SOME_STRING_VALUE_01)
                .stringData2(SOME_STRING_VALUE_02)
        ...
        assertAll(
                ...
                () -> assertTrue(actualResult.keySet().containsAll(
                        Stream.of(
                                STRING_DATA_1_FIELD.substring(0, 1).toLowerCase() + STRING_DATA_1_FIELD.substring(1),
                                STRING_DATA_2_FIELD.substring(0, 1).toLowerCase() + STRING_DATA_2_FIELD.substring(1),
                                STRING_DATA_3_FIELD.substring(0, 1).toLowerCase() + STRING_DATA_3_FIELD.substring(1))
                                .collect(toList()))),
                () -> assertTrue(actualResult.values().containsAll(
                        Stream.of(
                                EXPECTED_STRING_VALUE_01,
    ...
    @Disabled
    @Test
    void shouldExtractParametersOnSpecificIgnoreSettings() {
        val actualResult = getQueryParams(SimpleClass
                        .builder()
                        .stringData(SOME_STRING_VALUE_01)
                        .intData(SOME_INT_VALUE_01)
    ...
    void shouldExtractParametersFromEventListRequest() {
        ...
        val actualResult = getQueryParams(EventListRequest
                ...
                .pagedRequest(com.lykke.api.testing.queryparams.model.b.PagedRequestModel
                        .builder()
    ...
    void shouldConvertArray() {
        val fieldName = "SomeIds";
        val expectedResult = Stream.of(getRandomUuid(), getRandomUuid(), getRandomUuid())
                .sorted()
                .collect(toList())
                .toArray(new String[]{});

        val actualResult = getQueryParams(expectedResult, fieldName);

        assertAll(
                () -> actualResult.keySet().stream().allMatch(key -> key.equalsIgnoreCase(fieldName)),
                () -> assertArrayEquals(expectedResult,
                        actualResult.values().stream().sorted().collect(toList()).toArray(new String[]{}))
        );
    }
